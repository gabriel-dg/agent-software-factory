...
results.push(`${trials1} ${result1Stay.winRate.toFixed(4)} ${analytical1Stay.toFixed(4)} ${test1Stay.delta.toFixed(4)}`);
scenarios.push({ name: 'knowing 3 doors stay', trials: trials1 });
...
results.push(`${trials1} ${result1Switch.winRate.toFixed(4)} ${analytical1Switch.toFixed(4)} ${test1Switch.delta.toFixed(4)}`);
scenarios.push({ name: 'knowing 3 doors switch', trials: trials1 });
...
results.push(`${trials3} ${result3Stay.winRate.toFixed(4)} ${analytical3Stay.toFixed(4)} ${test3Stay.delta.toFixed(4)}`);
scenarios.push({ name: 'knowing 10 doors stay', trials: trials3 });
...
results.push(`${trials3} ${result3Switch.winRate.toFixed(4)} ${analytical3Switch.toFixed(4)} ${test3Switch.delta.toFixed(4)}`);
scenarios.push({ name: 'knowing 10 doors switch', trials: trials3 });
...
results.push(`${trials5} ${result5Stay.winRate.toFixed(4)} ${analytical5Stay.toFixed(4)} ${test5Stay.delta.toFixed(4)}`);
scenarios.push({ name: 'knowing 100 doors stay', trials: trials5 });
...
results.push(`${trials5} ${result5Switch.winRate.toFixed(4)} ${analytical5Switch.toFixed(4)} ${test5Switch.delta.toFixed(4)}`);
scenarios.push({ name: 'knowing 100 doors switch', trials: trials5 });
...
results.push(`${trials7} ${result7Stay.decidedWinRate.toFixed(4)} ${analytical7Stay.toFixed(4)} ${test7Stay.delta.toFixed(4)}`);
scenarios.push({ name: 'random 3 doors stay (decided rounds)', trials: trials7 });
...
results.push(`${trials7} ${result7Switch.decidedWinRate.toFixed(4)} ${analytical7Switch.toFixed(4)} ${test7Switch.delta.toFixed(4)}`);
scenarios.push({ name: 'random 3 doors switch (decided rounds)', trials: trials7 });
...
results.push(`${trials7} ${result7Stay.prizeRevealedRate.toFixed(4)} ${analytical9.toFixed(4)} ${test9.delta.toFixed(4)}`);
scenarios.push({ name: 'random 3 doors prize revealed rate', trials: trials7 });
...
console.log(`Trials per scenario: ${scenarios.map(s => s.trials).join(', ')}`);
